...
public class Main {
    ...
    private static URL getUrl(String stationCode) throws MalformedURLException {
         ...
         */
        String url= "https://dd.weather.gc.ca/hydrometric/csv/ON/daily/ON_" + stationCode + "_daily_hydrometric.csv";
        return new URL(url);
    }
    ...
    public static void main(String[] args) throws ParseException {
        ...
        var stationCode = cmd.getArgList().get(cmd.getArgList().size() - 1); //index out of bounds for some reason?
        ...
        try (var provider = new StationDataProvider(url)) {
             ...
             */
            if(cmd.hasOption('a')) {
                System.out.println(analyzer.averageWaterLevel());
                return;
            }
