...
public class Main extends Application {
     ...
     */
    static QuadraticCoefficients<Double> readCoefficients() {
    //static QuadraticCoefficients<Double> readCoefficients(InputStream inputStream) {
        try (var scanner = new Scanner(System.in)) {
            System.out.print("x^2 coefficient: ");
            var a = scanner.nextDouble();

            System.out.print("x^1 coefficient: ");
            var b = scanner.nextDouble();

            System.out.print("x^0 coefficient: ");
    ...
    public void start(Stage stage) {
        var coefficients = readCoefficients(); // get the values
